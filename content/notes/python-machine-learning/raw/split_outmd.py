...
base='python-machine-learning'

with open('out.md', errors='ignore' ) as f:
    lines=f.readlines()
...
for line in lines:
    ...
    if "![]" in line:
        ...
        temp = " caption=\"\" width=100% height=100%"
        newline="{{< figure src=/notes/"+base+"/img/"+image+temp+" >}}\n"
